...
facilities meet the diverse needs and preferences of our workforce.</p>
            ...
            <div className="hero min-h-screen bg-base-200 lg:px-10 px-0">
              ...
              <div>
                ...
                <div className='lg:ps-5 lg:w-1/2'>
                  ...
                  <p className="py-6 text-justify">First and foremost, we prioritize regulatory compliance to adhere to local regulations and
health codes. This commitment ensures that our food facilities consistently meet food safety
standards and legal requirements.</p>
            ...
            <div className="hero min-h-screen bg-base-200 lg:px-10 px-0">
              ...
              <div>
                ...
                <div className='lg:w-1/2'>
                  <h1 className="lg:text-5xl text-3xl  font-bold"></h1>
                  <p className="py-6 text-justify">In terms of infrastructure and space, we allocate a dedicated area equipped with modern
...
and quality.</p>
            ...
            <div className="hero min-h-screen bg-base-200 lg:px-10 px-0">
              ...
              <div>
                ...
                <div className='lg:w-1/2'>
                  <h1 className="lg:text-5xl text-3xl  font-bold"></h1>
                  <p className="py-6 text-justify">Our menu planning is driven by a commitment to diversity and nutrition. We cater to the
preferences and dietary needs of our employees, providing a range of options that are both
delicious and wholesome.</p>
            ...
            <div className="hero min-h-screen bg-base-200 lg:px-10 px-0">
              ...
              <div>
                ...
                <div className='lg:w-1/2'>
                  <h1 className="lg:text-5xl text-3xl  font-bold"></h1>
                  <p className="py-6 text-justify">We also invest in a well-trained and experienced staff to manage our food facilities. Our
...
have convenient access to nutritious meals.</p>
            ...
            <div className="hero min-h-screen bg-base-200 lg:px-10 px-0">
              ...
              <div>
                ...
                <div className='lg:w-1/2'>
                  <h1 className="lg:text-5xl text-3xl  font-bold"></h1>
                  <p className="py-6 text-justify">To continuously improve our offerings and services, we&#39;ve established a feedback
mechanism. This allows our employees to provide suggestions and comments, which we value
greatly, as they guide us in making enhancements to the food facility.</p>
            ...
            <div className="hero min-h-screen bg-base-200 lg:px-10 px-0">
              ...
              <div>
                ...
                <div className='lg:w-1/2'>
                  <h1 className="lg:text-5xl text-3xl  font-bold"></h1>
                  <p className="py-6 text-justify">Finally, we actively promote healthy eating habits among our employees. We encourage

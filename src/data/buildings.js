...
const sharedStandards = [
  {
    ...
    description: 'Production activities are aligned with the group commitment to reliable quality and consistent customer service.',
  },
  {
    title: 'Responsible manufacturing',
    description: 'The group emphasizes sustainability, social responsibility and ethical business practices.',
  },
  {
    title: 'Export oriented',
    description: 'Operations support international apparel buyers and export markets across the USA, UK, Europe and Canada.',
  },
];
...
export const buildings = [
  {
    ...
    number: '01',
    name: 'W. Apparels Ltd.',
    shortDescription: 'The main W. Apparels facility supporting knit and woven garment manufacturing for international markets.',
    overview:
    ...
    sections: [
      ...
      { title: 'Sewing Section', location: 'First, Second and Third Floors' },
      { title: 'Finishing Section', location: 'First, Second and Third Floors' },
  ...
  },
  {
    ...
    route: '/BUILDING2',
    number: '02',
    name: 'Quality Apparels Ltd.',
    shortDescription: 'A sister concern of W. Apparels Ltd. serving the group’s export-oriented apparel operations.',
    overview:
      'Quality Apparels Ltd. is listed in the official company profile as a sister concern of W. Apparels Ltd. The facility contributes to the group’s apparel manufacturing activities and follows the same focus on quality, reliability and responsible production.',
    image: qualityApparelsImage,
    facts: [
      { label: 'Organization type', value: 'W. Apparels sister concern' },
      { label: 'Industry', value: 'Apparel manufacturing' },
      { label: 'Business orientation', value: 'Export focused' },
      { label: 'Group markets', value: 'USA, UK, Europe and Canada' },
    ],
    sections: [],
    standards: sharedStandards,
  },
  {
    ...
    number: '03',
    name: '3NA Fashion',
    shortDescription: 'A woven-wear manufacturing concern with an annual production capacity of approximately 2.8 million pieces.',
    overview:
    ...
    facts: [
      { label: 'Organization type', value: 'W. Apparels sister concern' },
      { label: 'Product focus', value: 'Woven wear' },
      { label: 'Annual capacity', value: 'Approx. 2.8 million pieces' },
      { label: 'Business orientation', value: 'Export focused' },
    ],
    sections: [],
    standards: sharedStandards,

      ...
      <div className='pb-20'>
        ...
        <div className='px-20 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8'>
          <div className="card w-50 bg-base-100 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300">
            ...
            <div className='my-3'>
              <h2 className="card-title justify-center text-md">Safety Measures</h2>
            </div>
          </div>
          <div className="card w-50 bg-base-100 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300">
            <figure><img className='w-full' src={product2} alt="Shoes" /></figure>
            <div className='my-3'>
              <h2 className="card-title justify-center text-md">Medical Facilities</h2>
            </div>
          </div>
          <div className="card w-50 bg-base-100 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300">
            <figure><img className='w-full' src={product3} alt="Shoes" /></figure>
            <div className='my-3'>
              <h2 className="card-title justify-center text-md">Child care</h2>
          ...
          <div className="card w-50 bg-base-100 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300">
            ...
            <div className='my-3'>
              <h2 className="card-title justify-center text-md">Fire Training</h2>
          ...
          <div className="card w-50 bg-base-100 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300">
            ...
            <div className='my-3'>
              <h2 className="card-title justify-center text-md">First Aid Training</h2>
          ...
          <div className="card w-50 bg-base-100 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300">
            ...
            <div className='my-3'>
              <h2 className="card-title justify-center text-md">Food Facilities</h2>

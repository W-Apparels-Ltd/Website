...
import product1 from '../images/factory_purpose/111111.jpg'
import product2 from '../images/factory_purpose/mdfc.jpg'
...
import product6 from '../images/factory_purpose/foof.jpg'


const Facilities = () => {
  return (
    <div id='facilities' className=' min-h-screen  bg-base-100 lg:px-20'>
      <div className='pb-20'>
        <div className='p-10 text-center'><h1 className='lg:text-5xl text-2xl md:text-3xl text-primary font-bold'>Facilities</h1></div>

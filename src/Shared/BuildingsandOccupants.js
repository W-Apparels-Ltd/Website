      ...
      <div  className="hero min-h-screen py-5 lg:py-0 lg:px-20 px-5 mx-auto w-full bg-base-100 font-Nunito">
        <div className="flex flex-col lg:items-end lg:flex-row-reverse lg:justify-between lg:items-center  text-primary">
          ...
          <div className='flex flex-col items-center'>
            ...
            <img src={img1} className="w-44 h-44 lg:w-60 lg:h-60  object-cover relative -top-[30px] -left-[15px] mask mask-hexagon  shadow-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300" />
            <img src={img2} className="w-44 h-44 lg:w-60 lg:h-60  object-cover relative -top-[30px]  mask mask-hexagon  shadow-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300 " />
            </div>

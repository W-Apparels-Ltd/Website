  ...
  return (
    <div>
      <div className="hero min-h-screen bg-base-100 px-20">
          ...
          <div className='ps-20 text-center'>
            <h1 className="text-5xl text-primary font-bold">Message from the Chairman</h1>
            ...
            <div className='text-end text-2xl italic'><p>– Nigher Sultana, Chairman, W. Apparels Ltd.</p></div>
          </div>
      </div>
    </div>
  );

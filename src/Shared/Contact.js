...
const CONTACT_URL = 'https://wapparels-server.vercel.app/contactus';
...
const Contact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data.status !== undefined && Number(data.status) !== 201) {
        throw new Error(data.message || 'The server did not confirm delivery.');
      }
      ...
      <div className="flex flex-col items-center lg:flex-row lg:justify-between lg:items-start">
        <div className="p-5 lg:p-0 lg:text-left">
          ...
          <div className='lg:me-12 '>
            <iframe className='
            w-full h-[100px]
            lg:w-[550px] lg:h-[300px] mb-5' id="gmap_canvas" src="https://maps.google.com/maps?q=W apparels&t=&z=13&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0" title="W. Apparels location"></iframe>
          </div>
        ...
        <div className="card flex-shrink-0 lg:w-1/2 w-[90%] max-w-xl shadow-2xl bg-base-100 mb-5">
          <form onSubmit={handleSubmit} className="card-body">
            <div className="form-control">
              ...
              <input name='name' type="text" className="input input-bordered" required maxLength={100} />
            </div>
            <div className="form-control">
              <label className="label">
                <span className="label-text font-bold">Email</span>
              </label>
              <input name='email' type="email" className="input input-bordered" required maxLength={254} />
            ...
            <div className="form-control">
              ...
              <input name='subject' type="text" className="input input-bordered" required maxLength={150} />
            </div>
            <div className="form-control">
              <label className="label">
                <span className="label-text font-bold">Message</span>
              </label>
              <textarea name='message' className="textarea textarea-bordered" required maxLength={5000}></textarea>
            </div>

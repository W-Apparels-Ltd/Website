            ...
            <div className="bg-base-200 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div>
                ...
                <div className="mt-3 sm:ml-4 sm:mt-0 sm:text-left">
                  <h3 className="text-base text-center font-semibold leading-6 text-gray-900" id="modal-title">Mail Sent Successfully</h3>
                  <div className="mt-2">
                    <p className="text-sm text-center text-gray-800">“Thank you, your inquiry has been received. You can expect to hear back from us within the next 24-48 hours”</p>
                  </div>
                </div>
              </div>
            </div>

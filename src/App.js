import './App.css';
import { RouterProvider, createHashRouter } from 'react-router-dom'; // Changed to createHashRouter
...
function App() {
  // Switched createBrowserRouter -> createHashRouter for double-click file:// support
